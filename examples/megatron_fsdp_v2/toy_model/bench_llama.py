...
Usage:
    torchrun --nproc_per_node=8 examples/megatron_fsdp_v2/toy_model/bench_llama.py \\
...
def bench_one(args, device, mem_mgr=None):
    ...
    _utils.mem_log("after_model_init", rank=rank)
    ...
    _utils.mem_log("final", rank=rank)
...
def main():
    ...
    if args.record_memory_history:
        mem_mgr = _utils.MemoryHistoryManager(
