...
host="${HOSTNAME}"
NAME="mup-bf16-gpt-${MODEL_SIZE}B-lr-${LR}-minlr-${MIN_LR}-bs-${GLOBAL_BATCH_SIZE}-gpus-${NUM_GPUS}-mp-${MP_SIZE}-pp-${PP_SIZE}"
...
if [ "${USE_INTERNAL_DATA}" = "true" ]; then
    ...
    VOCAB_PATH=/cephfs/gpt/tokenizer/gpt2/gpt2-vocab.json
    MERGE_PATH=/cephfs/gpt/tokenizer/gpt2/gpt2-merges.txt
