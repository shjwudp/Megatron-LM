...
class DBuffer:
    ...
    # PORT-NOTE: `subgroup_size` is threaded through every derived buffer,
    # including the views and redistribute outputs; dev's `view()` drops the
    # metadata at its `from_local` calls. Keeping it makes subgroup metadata
    # survive derived buffers.
