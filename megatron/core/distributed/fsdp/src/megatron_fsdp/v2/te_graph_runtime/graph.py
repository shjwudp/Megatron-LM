...
class _CudaGraphInputMismatch(RuntimeError):
    """Report runtime inputs that do not match a captured graph surface."""
            ...
            def make_graphed_forward(
                ...
                def new_fwd(*user_args, **user_kwargs):
                    ...
                    if func.training == graph_training_state:
                        ...
                        except _CudaGraphInputMismatch:
                            if activation_recompute and replay_phase == "inference":
                                graph_replay_state["next_replay_phase"] = None
