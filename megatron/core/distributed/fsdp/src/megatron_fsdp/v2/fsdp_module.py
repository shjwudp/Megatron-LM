...
class _FSDPRootContext:
    ...
    """Whether graph capture should run at the next root forward."""
...
class FSDPModule:
    ...
    def enable_cuda_graph(
        ...
        With ``activation_recompute=True``, the module must run inside an
        non-reentrant activation checkpoint. M-FSDP selects the original-forward
        or recompute-forward graph from its forward/backward execution phase.
